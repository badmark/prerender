...
chrome.spawn = function(options) {
	return new Promise((resolve, reject) => {
		...
		this.chromeChild = spawn(location, this.options.chromeFlags || ['--headless', '--disable-gpu', '--remote-debugging-port=9222', '--hide-scrollbars', '--no-sandbox', '--disable-dev-shm-usage']);
